...
<head>
    ...
    <title>ACME AtronOmatic, LLC</title>
    ...
    <link href="assets/css/acme-purple.css" rel="stylesheet" type="text/css"> 
...
<body id="page-top">
    ...
    <header style="background-image: url('assets/img/bg-header.jpg');">
        <div class="intro-content">
            <img src="assets/img/profile@2x.png" class="img-responsive img-centered" alt="ACME AtronOmatic">
        ...
        <div class="container-fluid">
            <div class="row text-center">
                <div class="col-lg-12 wow fadeIn">
                    ...
                    <p>Nam id felis eu felis consequat adipiscing. Suspendisse sit amet faucibus nunc, dignissim vehicula enim.
Vestibulum luctus turpis sit amet varius venenatis.</p>
                    <hr class="colored">
                </div>
            </div>
            <div class="row text-center content-row">
                <div class="col-md-3 col-sm-6 wow fadeIn" data-wow-delay=".2s">
                    <div class="about-content">
                        ...
                        <h3>Dignissim Nisi</h3>
                        <p>Duis fringilla metus erat, in dignissim nisi scelerisque ut. Mauris volutpat libero eu libero maximus, et molestie ex rutrum.</p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 wow fadeIn" data-wow-delay=".4s">
                    <div class="about-content">
                        <i class="fa fa-edit fa-4x"></i>
                        <h3>Quisque feugiat</h3>
                        <p>Sed ut nisi nunc. Quisque feugiat lectus nec est tempus, dignissim aliquam risus molestie..</p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 wow fadeIn" data-wow-delay=".6s">
                    <div class="about-content">
                        ...
                        <h3>Vivamus vitae</h3>
                        <p>Vivamus vitae erat libero. In non faucibus elit, at iaculis justo. Fusce auctor feugiat tellus, vel pulvinar arcu vehicula vel.!</p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 wow fadeIn" data-wow-delay=".8s">
                    <div class="about-content">
                        <i class="fa fa-heart fa-4x"></i>
                        <h3>Facilisis Ante </h3>
                        <p>Etiam facilisis ante sed hendrerit eleifend. Integer lobortis augue ac viverra commodo. Integer quis eros quis tortor laoreet iaculis nec nec lacus.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container wow fadeIn">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <span class="quote">Good <span class="text-primary">engineering</span> is finding that perfect balance between the way something <span class="text-primary">looks</span> and how it <span class="text-primary">functions</span>.</span>
                    <hr class=" colored">
    ...
    <section id="work" class="bg-gray">
        <div class="container text-center wow fadeIn">
            <h2>Our Apps</h2>
            <hr class="colored">
            <p>Our apps Suspendisse tincidunt iaculis quam vitae tincidunt. Vivamus vitae erat libero. In non faucibus elit, at iaculis justo. Fusce auctor feugiat tellus, vel pulvinar arcu vehicula vel.s.</p>
        </div>
    </section>
      ...
      <section class="bg-gray"id="team">
        <div class="container text-center wow fadeIn">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Our Team</h2>
                    <p>We are a group of ipsum dolor sit amet, consectetur adipiscing elit. Proin tempus neque feugiat hendrerit lacinia.</p>
                    <hr class="colored">
                </div>
            </div>
                ...
                <div class="col-lg-10 col-lg-offset-1">
                    <div class="testimonials-carousel">
                        <div class="item">
                            <div class="row">
                                <div class="col-lg-12">
                                    <p class="lead">"ACME creates apps with both a valuable and rewarding experience."</p>
                                    <hr class="colored">
        ...
        <div class="container wow fadeIn">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>Contact Us</h2>
                    <hr class="colored">
                    <p>Sed ut nisi nunc. Quisque feugiat lectus nec est tempus, dignissim aliquam risus molestie. Praesent semper condimentum mattis.</p>
                </div>
            </div>
            <div class="row content-row">
        ...
        <div class="container text-center">
            <div class="row">
                ...
                <div class="col-md-4 contact-details">
                    ...
                    <p>121 Ash St  <br>Portland,ORA 90210</p>
                </div>
                <div class="col-md-4 contact-details">
                    <h4><i class="fa fa-envelope"></i> Email</h4>
                    <p><a href="mailto:mail@example.com">mail@acmeatronomatic.com</a>
                    </p>
                </div>
            </div>
            ...
            <div class="row copyright">
                <div class="col-lg-12">
                    <p class="small">&copy; 2015 ACME AtronOmatic, LLC</p>
                </div>
            </div>
        </div>
    </footer>
